...
class DicomWriter:
    ...
    def write(self, pixelData):
        ...
        self.ds.StudyDate = '0'              #primary angulation
        self.ds.StudyTime = '0'              #secondary angulation
        self.ds.KVP = "810.0"                #SPD
        self.ds.DistanceSourceToDetector = "1200.0"  #SID
        ...
        self.ds.PositionReferenceIndicator = '15'    #FD
        self.ds.Rows = 1024                  #image width
        self.ds.Columns = 1280               #image height
        self.ds.PixelSpacing = [0.110726, 0.110726]  #pixel spacing
    ...
    def generateHeader(self):
        ...
        ds.Rows = 1024
        ds.Columns = 1280
        ds.PixelSpacing = [0.110726, 0.110726]
        ds.BitsAllocated = 8
        ds.BitsStored = 8
        ds.HighBit = 7
